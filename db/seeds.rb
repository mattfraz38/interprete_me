...
Service.create!(remote_photo_url: night_life_img, days: 3, category: "Night Life", title: "Bar-hopping", description: "Come with me and I'll show you all the good side street locations to drink, eat, and meet other people.", price: 20, location: "Tokyo", user_id: matt.id)
...
Service.create!(remote_photo_url: relax_img, days: 1, category: "Relax", title: "Treat yourelf! Get a massage!", description: "Experienced massge therapist looking to make some extra money!", price: 15, location: "Australia", user_id: kat.id)
...
Service.create!(remote_photo_url: education_img, days: 1, category: "Education", title: "Want to learning Spanish?", description: "I'll teach you spanish while we explore the city!", price: 50, location: "Barcelona", user_id: larry.id)
...
Service.create!(remote_photo_url: sports_img, days: 2, category: "Sports", title: "See a boxing game", description: "Do you like boxing? Don't have anyone to go to a match with? Join me and I'll take to to a boxing match in Mexico!", price: 20, location: "Mexico City", user_id: george.id)
...
Service.create!(remote_photo_url: art_img, days: 6, category: "Art", title: "Lovely Madrid", description: "I'll show you around all the best musuems in Madrid", price: 4, location: "Madrid", user_id: larry.id)
...
Service.create!(remote_photo_url: night_life_img, days: 3, category: "Night Life", title: "Bars and pubs in Moscow", description: "I'll show you the best places to drink and meet people", price: 20, location: "Moscow", user_id: kat.id)
...
Service.create!(remote_photo_url: adventure_img, days: 3, category: "Adventure", title: "Hiking in Nepal", description: "New to or visiting Nepal? Do you like the outdoors and want to go hiking?", price: 100, location: "Tokyo", user_id: matt.id)
...
Service.create!(remote_photo_url: education_img, days: 48, category: "Education", title: "Fishing", description: "I'll teach you about deep sea fishing and how to catch the big one off the coast of Sydney", price: 150, location: "Sydney", user_id: kat.id)
...
Service.create!(remote_photo_url: adventure_img, days: 12, category: "Adventure", title: "Skiing in Switzerland", description: "If you're new to Switzerland and want to learn how to ski I'll teach you", price: 50, location: "Davos", user_id: matt.id)
...
Service.create!(remote_photo_url: sports_img, days: 2, category: "Sports", title: "Go to a Cricket game", description: "Want to learn about a strange game called cricket? Come with me and learn while watching a game in India from a former pro!", price: 20, location: "Anantapur", user_id: kat.id)
Service.create!(remote_photo_url: food_and_drink_img, days: 8, category: "Food&Drink", title: "Rome food tour", description: "Do you like Rome? Do you like food? I'll take you on a food tour through Rome", price: 50, location: "Rome", user_id: larry.id)
Service.create!(remote_photo_url: art_img, days: 10, category: "Art", title: "Tokyo street art", description: "Japan is very clean right? I'll show you the true face of street art in Tokyo", price: 15, location: "Tokyo", user_id: matt.id)
