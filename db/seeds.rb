...
Service.create!(days: 1, category: "Food", title: "Wine tasting", description: "Are you new to Paris? Do you enjoy the finner things in live? Lets go wine tasting! I'll show you all the best spots!", price: 40, location: "France", user_id: User.all.sample.id)
